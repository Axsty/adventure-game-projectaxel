...
public class StartRoom implements Room {
    ...
    public void enterRoom(Player player, UI ui) {
        ...
        boolean exit = false;
        while (!exit) {
            String choice = ui.getInput("Vilken dörr vill du ta? (1=Skog, 2=Fängelse, 3=Skattkammare, 4=Magiskt torn, 5=Grotta, 6=Draknäste, q=avsluta)");
            switch (choice) {
                case "1":
                ...
                case "3":
                    ...
                    break;
                case "4":
                    new HealingRoom().enterRoom(player, ui);
                    break;
                case "5":
                    new StrengthRoom().enterRoom(player, ui);
                    break;
                case "6":
                    new DragonRoom().enterRoom(player, ui);
                    break;
                case "q":
                    exit = true;
                    break;
